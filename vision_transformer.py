...
from quant_modules import IntGELU, QuantAct, IntSoftmax
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.attn_activation = QuantAct(32, quant_mode=True)
        self.softmax = IntSoftmax(32, quant_mode=True, force_dequant="none")
    ...
    def forward(self, x):
        ...
        attn, attn_scaling = self.attn_activation(attn, None)
        attn, attn_probs_scaling = self.softmax(attn,attn_scaling)
